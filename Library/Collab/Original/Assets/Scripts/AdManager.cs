...
public class AdManager : MonoBehaviour {
	...
	public void RequestBanner(){
		...
		bannerView = new BannerView(adUnitId, AdSize.Banner, AdPosition.Bottom); // Create a 320x50 banner at the top of the screen.
		...
		bannerView.OnAdLoaded += HandleOnAdLoaded; //Suscribirse al evento de Banner ha cargado. 
	}
