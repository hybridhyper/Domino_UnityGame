...
public class ControladorJuego : ControladorMaestro {
	...
	void WritePairsIntoChips() {
        ...
        foreach (Transform chiperror in listNoValidChips)
        {
            chiperror.GetComponent<Image>().color = Color.red;
        }
	}
    ...
    override public void CleanAllBoard() {
        ...
        foreach (Transform chiperror in chipZone.transform)
		{
            chiperror.GetComponent<Image>().color = Color.white;
		}
    }
