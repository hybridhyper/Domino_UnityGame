	...
	void Update () {
		...
		if (mustLerpLeft) {
			if (horizontal.value > 0.001) {
				...
				horizontal.value = 0;
				mustLerpLeft = false;
				lifesButton.color = Constantes.SHOP_TAB_SELECTED;
                lifesText.color = Constantes.SHOP_TAB_SELECTED_TEXT;
				coinsButton.color = Constantes.SHOP_TAB_NOTSELECTED;
                coinsText.color = Constantes.SHOP_TAB_NOT_SELECTED_TEXT;
				enoughSpeed = false;
			}
		}
		if (mustLerpRight) {
			if (horizontal.value < 0.99) {
				...
				horizontal.value = 1;
				mustLerpRight = false;
                lifesButton.color = Constantes.SHOP_TAB_NOTSELECTED;
                coinsButton.color = Constantes.SHOP_TAB_SELECTED;
				lifesText.color = Constantes.SHOP_TAB_NOT_SELECTED_TEXT;
				coinsText.color = Constantes.SHOP_TAB_SELECTED_TEXT;
				enoughSpeed = false;
			}
		}
	}
